...
Before getting started with the *visread* package, we recommend becoming familiar with the `casatools <https://casadocs.readthedocs.io/en/stable/api/casatools.html>`_ provided as part of CASA. You can see some of our highlights in the tutorials and in :ref:`casatools-api-label`.
